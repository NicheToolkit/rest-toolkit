 ...
 * <p>The rest access value advice interface.</p>
...
public interface RestAccessValueAdvice extends RestAccessValue {
   ...
   default String accessToken(RestHttpRequest httpRequest) {
     ...
     * <p>The do access token handle method.</p>
     ...
     * @return {@link java.lang.String} <p>The do access token handle return object is <code>String</code> type.</p>
     ...
     * <p>The do access auth handle method.</p>
     * @param httpRequest {@link io.github.nichetoolkit.rest.RestHttpRequest} <p>The http request parameter is <code>RestHttpRequest</code> type.</p>
     * @return {@link java.lang.String} <p>The do access auth handle return object is <code>String</code> type.</p>
     * @see io.github.nichetoolkit.rest.RestHttpRequest
     * @see java.lang.String
     */
     ...
     * <p>The do attribute handle method.</p>
     * @param httpRequest {@link io.github.nichetoolkit.rest.RestHttpRequest} <p>The http request parameter is <code>RestHttpRequest</code> type.</p>
     * @param attribute   {@link java.lang.String} <p>The attribute parameter is <code>String</code> type.</p>
     * @return {@link java.lang.String} <p>The do attribute handle return object is <code>String</code> type.</p>
     * @see io.github.nichetoolkit.rest.RestHttpRequest
     * @see java.lang.String
     */
     ...
     * <p>The do attributes handle method.</p>
     * @param httpRequest {@link io.github.nichetoolkit.rest.RestHttpRequest} <p>The http request parameter is <code>RestHttpRequest</code> type.</p>
     * @param attributes  {@link java.util.Collection} <p>The attributes parameter is <code>Collection</code> type.</p>
     * @return {@link java.lang.String} <p>The do attributes handle return object is <code>String</code> type.</p>
     * @see io.github.nichetoolkit.rest.RestHttpRequest
