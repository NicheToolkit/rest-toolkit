...
public interface JwtSigner extends RestAlgorithm<Algorithm> {
     ...
     * @return {@link io.github.nichetoolkit.fusionauth.jwt.Signer} <p>The signer return object is <code>Signer</code> type.</p>
     ...
     * @return {@link io.github.nichetoolkit.fusionauth.jwt.Verifier} <p>The verifier return object is <code>Verifier</code> type.</p>
