...
import io.github.nichetoolkit.rest.helper.XmlPurityHelper;
...
public class XmlPurityUtils {


    /**
     * <code>parseXml</code>
     * <p>The parse xml method.</p>
     * @param <T>  {@link Object} <p>The parameter can be of any type.</p>
     * @param target T <p>The target parameter is <code>T</code> type.</p>
     * @param file {@link File} <p>The file parameter is <code>File</code> type.</p>
     * @see  File
     */
    public static <T> void parseXml(T target, File file) {
        try {
            XmlPurityHelper.parseXml(target, file);
     ...
     * @param <T>  {@link Object} <p>The parameter can be of any type.</p>
     * @param target T <p>The target parameter is <code>T</code> type.</p>
     * @param outputStream {@link OutputStream} <p>The output stream parameter is <code>OutputStream</code> type.</p>
     * @see  OutputStream
     */
    public static <T> void parseXml(T target, OutputStream outputStream) {
        try {
            XmlPurityHelper.parseXml(target, outputStream);
        } catch (XmlParseException exception) {
     ...
     * @param <T>  {@link Object} <p>The parameter can be of any type.</p>
     * @param target T <p>The target parameter is <code>T</code> type.</p>
     * @param writer {@link Writer} <p>The writer parameter is <code>Writer</code> type.</p>
     * @see  Writer
     */
    public static <T> void parseXml(T target, Writer writer) {
        try {
            XmlPurityHelper.parseXml(target, writer);
        } catch (XmlParseException exception) {
     ...
     * @param <T>  {@link Object} <p>The parameter can be of any type.</p>
     * @param target T <p>The target parameter is <code>T</code> type.</p>
     * @return  {@link String} <p>The parse xml return object is <code>String</code> type.</p>
     * @see  String
     */
    public static <T> String parseXml(T target) {
        try {
            return XmlPurityHelper.parseXml(target);
        } catch (XmlParseException exception) {
    ...
    public static <T> byte[] parseXmlAsBytes(T target) {
        try {
            return XmlPurityHelper.parseXmlAsBytes(target);
        } catch (XmlParseException exception) {
     ...
     * @param <T>  {@link Object} <p>The parameter can be of any type.</p>
     * @param target T <p>The target parameter is <code>T</code> type.</p>
     * @param typeReference {@link TypeReference} <p>The type reference parameter is <code>TypeReference</code> type.</p>
     * @see  TypeReference
     * @see  String
     * @return  {@link String} <p>The parse xml return object is <code>String</code> type.</p>
     */
    public static <T> String parseXml(T target, TypeReference<?> typeReference) {
        try {
            return XmlPurityHelper.parseXml(target, typeReference);
        } catch (XmlParseException exception) {
     ...
     * @param <T>  {@link Object} <p>The parameter can be of any type.</p>
     * @param target T <p>The target parameter is <code>T</code> type.</p>
     * @return  {@link String} <p>The parse xml ignore null return object is <code>String</code> type.</p>
     * @see  String
     */
    public static <T> String parseXmlIgnoreNull(T target) {
        try {
            return XmlPurityHelper.parseXmlIgnoreNull(target);
        } catch (XmlParseException exception) {
     ...
     * @param <T>  {@link Object} <p>The parameter can be of any type.</p>
     * @param xml {@link File} <p>The xml parameter is <code>File</code> type.</p>
     * @param clazz {@link Class} <p>The clazz parameter is <code>Class</code> type.</p>
     * @see  File
     * @see  Class
    ...
    public static <T> T parseBean(File xml, Class<T> clazz) {
        try {
            return XmlPurityHelper.parseBean(xml, clazz);
     ...
     * <p>The parse bean method.</p>
     * @param <T>  {@link Object} <p>The parameter can be of any type.</p>
     * @param xml {@link Reader} <p>The xml parameter is <code>Reader</code> type.</p>
     * @param clazz {@link Class} <p>The clazz parameter is <code>Class</code> type.</p>
     * @see  Reader
     * @see  Class
     * @return T <p>The parse bean return object is <code>T</code> type.</p>
     ...
     * <p>The parse bean method.</p>
     * @param <T>  {@link Object} <p>The parameter can be of any type.</p>
     * @param xml {@link InputStream} <p>The xml parameter is <code>InputStream</code> type.</p>
     * @param clazz {@link Class} <p>The clazz parameter is <code>Class</code> type.</p>
     * @see  InputStream
     * @see  Class
     * @return T <p>The parse bean return object is <code>T</code> type.</p>
     ...
     * <p>The parse bean method.</p>
     * @param <T>  {@link Object} <p>The parameter can be of any type.</p>
     * @param xml {@link String} <p>The xml parameter is <code>String</code> type.</p>
     * @param clazz {@link Class} <p>The clazz parameter is <code>Class</code> type.</p>
     * @see  String
     * @see  Class
     * @return T <p>The parse bean return object is <code>T</code> type.</p>
    ...
    public static <T> T parseBean(File xml, TypeReference<T> typeReference) {
        try {
            return XmlPurityHelper.parseBean(xml, typeReference);
        } catch (XmlParseBeanException exception) {
     ...
     * @param <T>  {@link Object} <p>The parameter can be of any type.</p>
     * @param xml {@link File} <p>The xml parameter is <code>File</code> type.</p>
     * @param javaType {@link JavaType} <p>The java type parameter is <code>JavaType</code> type.</p>
     * @see  File
     * @see  JavaType
     * @return T <p>The parse bean return object is <code>T</code> type.</p>
     */
    public static <T> T parseBean(File xml, JavaType javaType) {
        try {
            return XmlPurityHelper.parseBean(xml, javaType);
        } catch (XmlParseBeanException exception) {
     ...
     * <p>The parse bean method.</p>
     * @param <T>  {@link Object} <p>The parameter can be of any type.</p>
     * @param <U>  {@link Object} <p>The parameter can be of any type.</p>
     * @param xml {@link File} <p>The xml parameter is <code>File</code> type.</p>
     * @param clazz {@link Class} <p>The clazz parameter is <code>Class</code> type.</p>
     * @param innerClazz {@link Class} <p>The inner clazz parameter is <code>Class</code> type.</p>
     * @see  File
     * @see  Class
     * @return T <p>The parse bean return object is <code>T</code> type.</p>
     */
    public static <T, U> T parseBean(File xml, Class<T> clazz, Class<U> innerClazz) {
        try {
            return XmlPurityHelper.parseBean(xml, clazz, innerClazz);
        } catch (XmlParseBeanException exception) {
     ...
     * @param <T>  {@link Object} <p>The parameter can be of any type.</p>
     * @param xml {@link File} <p>The xml parameter is <code>File</code> type.</p>
     * @param listType {@link CollectionType} <p>The list type parameter is <code>CollectionType</code> type.</p>
     * @see  File
     * @see  CollectionType
     * @see  List
     * @return  {@link List} <p>The parse list return object is <code>List</code> type.</p>
     */
    public static <T> List<T> parseList(File xml, CollectionType listType) {
        try {
            return XmlPurityHelper.parseList(xml, listType);
    ...
    public static <T> List<T> parseList(File xml, TypeReference<List<T>> typeReference) {
        try {
            return XmlPurityHelper.parseList(xml, typeReference);
        } catch (XmlParseListException exception) {
     ...
     * <code>parseList</code>
     * <p>The parse list method.</p>
     * @param <Z>  {@link List} <p>The generic parameter is <code>List</code> type.</p>
     * @param <T>  {@link Object} <p>The parameter can be of any type.</p>
     * @param xml {@link File} <p>The xml parameter is <code>File</code> type.</p>
     * @param parseClazz {@link Class} <p>The parse clazz parameter is <code>Class</code> type.</p>
     * @param clazz {@link Class} <p>The clazz parameter is <code>Class</code> type.</p>
     * @see  List
     * @see  File
     * @see  Class
     ...
     * @param <T>  {@link Object} <p>The parameter can be of any type.</p>
     * @param xml {@link File} <p>The xml parameter is <code>File</code> type.</p>
     * @param setType {@link CollectionType} <p>The set type parameter is <code>CollectionType</code> type.</p>
     * @see  File
     * @see  CollectionType
     * @see  Set
     * @return  {@link Set} <p>The parse set return object is <code>Set</code> type.</p>
     */
    public static <T> Set<T> parseSet(File xml, CollectionType setType) {
        try {
            return XmlPurityHelper.parseSet(xml, setType);
    ...
    public static <T> Set<T> parseSet(File xml, TypeReference<Set<T>> typeReference) {
        try {
            return XmlPurityHelper.parseSet(xml, typeReference);
        } catch (XmlParseSetException exception) {
     ...
     * <code>parseSet</code>
     * <p>The parse set method.</p>
     * @param <Z>  {@link Set} <p>The generic parameter is <code>Set</code> type.</p>
     * @param <T>  {@link Object} <p>The parameter can be of any type.</p>
     * @param xml {@link File} <p>The xml parameter is <code>File</code> type.</p>
     * @param parseClazz {@link Class} <p>The parse clazz parameter is <code>Class</code> type.</p>
     * @param clazz {@link Class} <p>The clazz parameter is <code>Class</code> type.</p>
     ...
     * @param xml {@link File} <p>The xml parameter is <code>File</code> type.</p>
     * @param mapType {@link MapType} <p>The map type parameter is <code>MapType</code> type.</p>
     * @see  File
     * @see  MapType
     * @see  Map
     * @return  {@link Map} <p>The parse map return object is <code>Map</code> type.</p>
     */
    public static <T, K> Map<T, K> parseMap(File xml, MapType mapType) {
        try {
            return XmlPurityHelper.parseMap(xml, mapType);
    ...
    public static <T, K> Map<T, K> parseMap(File xml, TypeReference<Map<T, K>> typeReference) {
        try {
            return XmlPurityHelper.parseMap(xml, typeReference);
        } catch (XmlParseMapException exception) {
     ...
     * @param <T>  {@link Object} <p>The parameter can be of any type.</p>
     * @param xml {@link File} <p>The xml parameter is <code>File</code> type.</p>
     * @param arrayType {@link ArrayType} <p>The array type parameter is <code>ArrayType</code> type.</p>
     * @see  File
     * @see  ArrayType
    ...
    public static <T> T[] parseArray(File xml, ArrayType arrayType) {
        try {
            return XmlPurityHelper.parseArray(xml, arrayType);
    ...
    public static <T> T[] parseArray(File xml, TypeReference<T> typeReference) {
        try {
            return XmlPurityHelper.parseArray(xml, typeReference);
        } catch (XmlParseArrayException exception) {
     ...
     * <code>parseMap</code>
     * <p>The parse map method.</p>
     * @param <Z>  {@link Map} <p>The generic parameter is <code>Map</code> type.</p>
     * @param <T>  {@link Object} <p>The parameter can be of any type.</p>
     * @param <K>  {@link Object} <p>The parameter can be of any type.</p>
     * @param xml {@link File} <p>The xml parameter is <code>File</code> type.</p>
     * @param parseClazz {@link Class} <p>The parse clazz parameter is <code>Class</code> type.</p>
     * @param keyClazz {@link Class} <p>The key clazz parameter is <code>Class</code> type.</p>
     * @param valueClazz {@link Class} <p>The value clazz parameter is <code>Class</code> type.</p>
     * @see  Map
     * @see  File
     * @see  Class
     * @return  {@link Map} <p>The parse map return object is <code>Map</code> type.</p>
     ...
     * @param <H>  {@link List} <p>The generic parameter is <code>List</code> type.</p>
     * @param <Y>  {@link Map} <p>The generic parameter is <code>Map</code> type.</p>
     * @param <T>  {@link Object} <p>The parameter can be of any type.</p>
     * @param <K>  {@link Object} <p>The parameter can be of any type.</p>
     * @param xml {@link File} <p>The xml parameter is <code>File</code> type.</p>
     * @param parseListClazz {@link Class} <p>The parse list clazz parameter is <code>Class</code> type.</p>
     * @param parseMapClazz {@link Class} <p>The parse map clazz parameter is <code>Class</code> type.</p>
     * @param keyClazz {@link Class} <p>The key clazz parameter is <code>Class</code> type.</p>
     * @param valueClazz {@link Class} <p>The value clazz parameter is <code>Class</code> type.</p>
     * @see  List
     * @see  Map
     * @see  File
     * @see  Class
     * @return  {@link Map} <p>The parse map list return object is <code>Map</code> type.</p>
     */
     ...
     * @param <K>  {@link Object} <p>The parameter can be of any type.</p>
     * @param xml {@link File} <p>The xml parameter is <code>File</code> type.</p>
     * @param wrapKeyClazz {@link Class} <p>The wrap key clazz parameter is <code>Class</code> type.</p>
     * @param contentMapClazz {@link Class} <p>The content map clazz parameter is <code>Class</code> type.</p>
     * @param contentKeyClazz {@link Class} <p>The content key clazz parameter is <code>Class</code> type.</p>
     * @param contentValueClazz {@link Class} <p>The content value clazz parameter is <code>Class</code> type.</p>
     * @see  List
     * @see  Map
     * @see  File
     * @see  Class
     * @return  {@link List} <p>The parse list map return object is <code>List</code> type.</p>
     */
     ...
     * @param <H>  {@link Map} <p>The generic parameter is <code>Map</code> type.</p>
     * @param <Y>  {@link Map} <p>The generic parameter is <code>Map</code> type.</p>
     * @param <Z>  {@link Object} <p>The parameter can be of any type.</p>
     * @param <T>  {@link Object} <p>The parameter can be of any type.</p>
     * @param <K>  {@link Object} <p>The parameter can be of any type.</p>
     * @param xml {@link File} <p>The xml parameter is <code>File</code> type.</p>
     * @param wrapMapClazz {@link Class} <p>The wrap map clazz parameter is <code>Class</code> type.</p>
     * @param contentMapClazz {@link Class} <p>The content map clazz parameter is <code>Class</code> type.</p>
     * @param wrapKeyClazz {@link Class} <p>The wrap key clazz parameter is <code>Class</code> type.</p>
     * @param contentKeyClazz {@link Class} <p>The content key clazz parameter is <code>Class</code> type.</p>
     * @param contentValueClazz {@link Class} <p>The content value clazz parameter is <code>Class</code> type.</p>
     ...
     * @see  File
     * @see  Class
     * @return  {@link Map} <p>The parse map map return object is <code>Map</code> type.</p>
     */
    ...
    public static <T> T parseConvert(Object value, Class<T> clazz) {
        try {
            return XmlPurityHelper.parseConvert(value, clazz);
    ...
    public static <T> T parseConvert(Object value, TypeReference<T> typeReference) {
        try {
            return XmlPurityHelper.parseConvert(value, typeReference);
        } catch (XmlParseConvertException exception) {
    ...
    public static <T> T parseConvert(Object value, JavaType javaType) {
        try {
            return XmlPurityHelper.parseConvert(value, javaType);
        } catch (XmlParseConvertException exception) {
