 ...
 * @since 1.8
 */
final class StreamSortedOps {

    private StreamSortedOps() { }
     ...
     */
    static <T> Stream<T> makeRef(StreamAbstractPipeline<?, T, ?> upstream) {
     ...
     * @param upstream a reference stream with element type T
     */
    static <T> IntStream makeInt(StreamAbstractPipeline<?, Integer, ?> upstream) {
     ...
     * @param upstream a reference stream with element type T
     */
    static <T> LongStream makeLong(StreamAbstractPipeline<?, Long, ?> upstream) {
     ...
     * @param upstream a reference stream with element type T
     */
    static <T> DoubleStream makeDouble(StreamAbstractPipeline<?, Double, ?> upstream) {
     ...
     */
    private static final class OfRef<T> extends  StreamReferencePipeline.StatefulOp<T, T> {
        /**
         ...
         * {@code Comparable}.
         */
        OfRef(StreamAbstractPipeline<?, T, ?> upstream) {
         ...
         */
        OfRef(StreamAbstractPipeline<?, T, ?> upstream, Comparator<? super T> comparator) {
            super(upstream, DefaultStreamShape.REFERENCE,
    ...
    private static final class OfInt extends StreamIntPipeline.StatefulOp<Integer> {
        OfInt(StreamAbstractPipeline<?, Integer, ?> upstream) {
    ...
    private static final class OfLong extends StreamLongPipeline.StatefulOp<Long> {
        OfLong(StreamAbstractPipeline<?, Long, ?> upstream) {
    ...
    private static final class OfDouble extends StreamDoublePipeline.StatefulOp<Double> {
        OfDouble(StreamAbstractPipeline<?, Double, ?> upstream) {
