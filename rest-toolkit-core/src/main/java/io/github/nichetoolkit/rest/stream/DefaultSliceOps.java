...
//     *        is to be imposed
//     */
//    public static IntStream makeInt(DefaultAbstractPipeline<?, Integer, ?> upstream,
//                                    long skip, long limit) {
//        if (skip < 0)
//            throw new IllegalArgumentException("Skip must be non-negative: " + skip);
//
...
//     *        is to be imposed
//     */
//    public static LongStream makeLong(DefaultAbstractPipeline<?, Long, ?> upstream,
//                                      long skip, long limit) {
//        if (skip < 0)
//            throw new IllegalArgumentException("Skip must be non-negative: " + skip);
//
...
//     *        is to be imposed
//     */
//    public static DoubleStream makeDouble(DefaultAbstractPipeline<?, Double, ?> upstream,
//                                          long skip, long limit) {
//        if (skip < 0)
//            throw new IllegalArgumentException("Skip must be non-negative: " + skip);
//
