...
abstract class DefaultReferencePipeline<P_IN, P_OUT>
    ...
    DefaultReferencePipeline(Supplier<? extends Spliterator<?>> source,
                             int sourceFlags, boolean parallel) {
        super(source, sourceFlags, parallel);
    }

    DefaultReferencePipeline(Spliterator<?> source,
                             int sourceFlags, boolean parallel) {
        super(source, sourceFlags, parallel);
    }
    ...
    @NonNull
    @Override
    public RestStream<P_OUT> unordered() {
        if (!isOrdered())
            return this;
    ...
    @Override
    public final RestStream<P_OUT> filter(Predicate<? super P_OUT> predicate) {
    ...
    @Override
    public final <R> RestStream<R> map(Function<? super P_OUT, ? extends R> mapper) {
...
//    }
    ...
    @Override
    public final <R> RestStream<R> flatMap(Function<? super P_OUT, ? extends RestStream<? extends R>> mapper) {
        Objects.requireNonNull(mapper);
        return new StatelessOp<P_OUT, R>(this, DefaultStreamShape.REFERENCE,
            ...
            DefaultSink<P_OUT> opWrapSink(int flags, DefaultSink<R> sink) {
                return new DefaultSink.ChainedReference<P_OUT, R>(sink) {
                    ...
                    @Override
                    public void accept(P_OUT u) {
                        try (RestStream<? extends R> result = mapper.apply(u)) {
                            if (result != null) {
...
//    }
    ...
    @Override
    public final RestStream<P_OUT> peek(Consumer<? super P_OUT> action) {
    ...
    @Override
    public final RestStream<P_OUT> distinct() {
        return DefaultDistinctOps.makeRef(this);
    }

    @Override
    public final RestStream<P_OUT> sorted() {
        return DefaultSortedOps.makeRef(this);
    }

    @Override
    public final RestStream<P_OUT> sorted(Comparator<? super P_OUT> comparator) {
        return DefaultSortedOps.makeRef(this, comparator);
    }

    @Override
    public final RestStream<P_OUT> limit(long maxSize) {
        if (maxSize < 0)
    ...
    @Override
    public final RestStream<P_OUT> skip(long n) {
        if (n < 0)
