 ...
 * <p>The predicate actuator interface.</p>
...
public interface PredicateActuator<T> extends Predicate<T> {
     ...
     * @return {@link io.github.nichetoolkit.rest.actuator.PredicateActuator} <p>The and return object is <code>PredicateActuator</code> type.</p>
     * @throws RestException {@link io.github.nichetoolkit.rest.RestException} <p>The rest exception is <code>RestException</code> type.</p>
     * @see io.github.nichetoolkit.rest.RestException
     */
     ...
     * @return {@link io.github.nichetoolkit.rest.actuator.PredicateActuator} <p>The negates return object is <code>PredicateActuator</code> type.</p>
     * @throws RestException {@link io.github.nichetoolkit.rest.RestException} <p>The rest exception is <code>RestException</code> type.</p>
     * @see io.github.nichetoolkit.rest.RestException
     */
     ...
     * <p>The or method.</p>
     * @param other {@link io.github.nichetoolkit.rest.actuator.PredicateActuator} <p>The other parameter is <code>PredicateActuator</code> type.</p>
     * @return {@link io.github.nichetoolkit.rest.actuator.PredicateActuator} <p>The or return object is <code>PredicateActuator</code> type.</p>
     * @throws RestException {@link io.github.nichetoolkit.rest.RestException} <p>The rest exception is <code>RestException</code> type.</p>
     * @see io.github.nichetoolkit.rest.RestException
     */
     ...
     * @return {@link io.github.nichetoolkit.rest.actuator.PredicateActuator} <p>The is equal return object is <code>PredicateActuator</code> type.</p>
     * @throws RestException {@link io.github.nichetoolkit.rest.RestException} <p>The rest exception is <code>RestException</code> type.</p>
